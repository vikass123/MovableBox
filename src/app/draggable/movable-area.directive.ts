  ...
  ngAfterContentInit(): void {
    this.movables.changes.subscribe(() => {
      ...
      this.movables.forEach(movable => {
        ...
        this.subscriptions.push(movable.moveUp.subscribe(() => this.maintainBoundaries(movable)));
        this.subscriptions.push(movable.moveRight.subscribe(() => this.maintainBoundaries(movable)));
        this.subscriptions.push(movable.moveDown.subscribe(() => this.maintainBoundaries(movable)));
        this.subscriptions.push(movable.moveLeft.subscribe(() => this.maintainBoundaries(movable)));
      });
    });
